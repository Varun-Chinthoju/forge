...
Dragging an app to the Trash leaves its support files scattered around your Library. Forge's
...
Forge **checks** for Full Disk Access and **never asks** for it. See
