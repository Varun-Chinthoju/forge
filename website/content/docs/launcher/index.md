---
title: App launcher
description: One search across everything Forge knows about, and how it decides what comes first.
---
...
Forge looks at several names for each entry, and trusts some more than others:
...
Forge learns which result you pick for a search, on your Mac, and moves it up next time.
...
What it learns stays in `launcher-ranking.json` in Forge's own folder and goes nowhere else.
...
Forge looks **one folder deep**, so `/Applications/Blackmagic Design/DaVinci Resolve.app` is found
...
[system action](/docs/launcher/system-actions). It leaves Finder and Forge running.
