...
Restore Window also works on windows Forge has never moved, because it notes the frame before the first
...
app refuses to shrink, Forge lines the window up against its side **once**, never in a loop.
