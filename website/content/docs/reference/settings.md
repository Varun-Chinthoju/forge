...
| [Calendar](/docs/features/calendar)                   | Join meetings from Forge       | Show in launcher, Upcoming meetings in launcher (**3 next**), Include Tomorrow's Events (**On**), Show the join card (**5 minutes**), Auto Join Meetings (**Off**), Camera Preview (**Off**), menu bar settings, Calendar commands, Calendars |
