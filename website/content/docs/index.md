...
description: What Forge is, and the few minutes it takes to set up.
---

Forge is a small, native launcher for macOS. It lives in your menu bar. Press your shortcut, a
...
The first time Forge opens, a short welcome takes you through these steps. You can skip any of
them and come back later.

### 1. Pick a shortcut

**Forge ships with no shortcut bound.** Nothing happens until you choose one. That is on purpose:
...
The same step has a **Launch at login** switch, so Forge is ready after a restart.

### 2. Allow pasting (optional)

Forge asks for Accessibility so it can paste a clip or an emoji back into the app you came from.
The launcher itself needs no permission. See [Permissions](/docs/permissions).

### 3. Bring your Raycast setup (optional)

If you used Raycast, pick its `.rayconfig` export. Forge brings your shortcuts, favorites,
...
Next: [the palette](/docs/palette), or [install Forge](/docs/install) if you have not yet.
