...
- Servers start when you use chat and stop after **10 idle minutes**, or when Forge quits.
- Forge offers nothing back to a server. Requests from a server, like sampling, are declined.
