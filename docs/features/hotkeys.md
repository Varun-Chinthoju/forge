...
to re-register from
and to prune bindings whose record was deleted while Forge wasn't running. That prune is why
...
window — that is un-remapped HID behaviour, not something Forge can stop.
