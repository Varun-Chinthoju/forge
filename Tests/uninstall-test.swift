...
struct UninstallTests {
    ...
    static let ownBundleID = "com.varun.forge.app"
    static let ownBundleURL = URL(fileURLWithPath: "/Applications/Forge.app")
    ...
    static func testIdentityRefusal() {
        let byID = UninstallTarget(
            ...
            bundleID: "com.varun.forge.app", displayName: "Forge", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: byID, otherAppNames: [], ownBundleID: ownBundleID,
                ownBundleURL: ownBundleURL) == nil,
            "Forge refuses to plan its own uninstall by bundle ID")

        let dev = UninstallTarget(
            bundleURL: URL(fileURLWithPath: "/Applications/Forge Dev.app"),
            bundleID: "com.varun.forge.app.dev", displayName: "Forge Dev", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: dev, otherAppNames: [], ownBundleID: "com.varun.forge.app.dev",
                ownBundleURL: URL(fileURLWithPath: "/Applications/Forge Dev.app")) == nil,
