...
struct UpdatesTests {
    ...
    static func derivesChannels() {
        let stable = ReleaseChannel(bundleID: "com.varun.forge.app")
        let beta = ReleaseChannel(bundleID: "com.varun.forge.app.beta")
        let dev = ReleaseChannel(bundleID: "com.varun.forge.app.dev")
    ...
    static func entry(
        tag: String, prerelease: Bool, draft: Bool = false, assets: [String] = ["Forge-x.zip"],
        body: String = "Notes."
    ) -> String {
        let list = assets.map {
            """
    ...
    static func rejectsUnusableFeeds() {
        ...
        expect(
            ReleaseFeed.newest(
                from: feed(entry(tag: "v0.3.0", prerelease: false, assets: ["Forge-x.dmg"])),
    ...
    static func picksTheZipThisMacCanRun() {
        let both = feed(
            entry(
                ...
                assets: ["Forge-0.3.0.zip", "Forge-Universal-0.3.0.zip"]))
        expect(
        ...
        let thinOnly = feed(entry(tag: "v0.3.0", prerelease: false, assets: ["Forge-0.3.0.zip"]))
        expect(
        ...
        let universalOnly = feed(
            entry(tag: "v0.3.0", prerelease: false, assets: ["Forge-Universal-0.3.0.zip"]))
        expect(
