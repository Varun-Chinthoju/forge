...
struct QuicklinkTests {
    ...
    static let home = "/Users/forge-harness"
    ...
    static func pathDetection() {
        ...
        expect(
            detect("  ~/Projects/Forge  ") == .path("\(home)/Projects/Forge"),
    ...
    static func scratchDirectory() -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("forge-quicklink-test-\(UUID().uuidString)", isDirectory: true)
