...
struct OnboardingView: View {
    ...
    private var subtitle: String {
        ...
        case 1: "Let Forge paste items back into the app you were using."
    ...
    private var readyMessage: String {
        if let caps = hotKeys.binding(for: .togglePalette)?.keycaps {
            return "Press \(caps.joined()) anytime to start using Forge."
        }
        return "Forge is ready. Set a shortcut in Settings to summon it."
    }
    ...
    private var shortcutStep: some View {
        ...
        return VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            OnboardingCard {
                OnboardingRow(
                    title: "App Launcher",
                    subtitle: "Press this shortcut to open Forge.",
                ...
                OnboardingRow(
                    ...
                    subtitle: "Start Forge automatically when you log in.",
