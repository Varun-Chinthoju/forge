...
final class SupportCoordinator {
    /// The one place the project URL is written down; every surface links to this.
    static let checkout = URL(
        string: "https://github.com/Varun-Chinthoju/forge")!
    ...
    private lazy var window = AppWindowController(
        title: "Support Forge", contentSize: SupportWindowView.initialSize,
