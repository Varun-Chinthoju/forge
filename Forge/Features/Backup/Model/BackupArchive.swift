...
/// Seals a `BackupBundle` directory into one `.forge` file, and opens one back up.
enum BackupArchive {
    static let fileExtension = "forge"
    ...
    enum ArchiveError: LocalizedError, Equatable {
        ...
        var errorDescription: String? {
            ...
            case .cannotRead: return "This file isn't a Forge backup, or it's damaged."
            }
        }
    }
