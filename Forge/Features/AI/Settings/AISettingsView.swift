...
struct AISettingsView: View {
        ...
        Section {
            ...
            AIModelSelectionRows(
                ...
                modelLabel: {
                    ...
                    Text("Used by Forge features unless they ask you to choose another model.")
                },
                effortLabel: {
    ...
    private var defaultModelFooter: String {
        ...
        return settings.defaultModel == nil
            ...
            : "Forge contacts only the selected provider when an AI feature runs."
    }
    ...
    private var systemPromptSection: some View {
        ...
        return Section {
            Toggle(isOn: $settings.systemPromptEnabled) {
                ...
                Text("Off sends nothing ahead of your message, not even what Forge says about itself.")
            }
            ...
            Text(
                "Your text is sent ahead of every message in every chat, after what Forge "
    ...
    private var installedAISection: some View {
        Section {
            ...
            Text(
                "Forge uses the Codex, Claude and OpenCode commands already installed and signed "
                    + "in on this Mac. Forge never stores or asks for their API keys."
            )
            .font(.caption)
            .foregroundStyle(.secondary)
        }
        ...
        if settings.enabledInstalledProviders.contains(kind) {
            ...
            case .notInstalled:
                LabeledContent {
                    ...
                    Text("Forge could not find the \(kind.command) command.")
                }
            case .failed(let message):
                LabeledContent {
                    providerActions {
