...
private final class InstalledCLITurnRunner {
    private static let safetyInstructions = """
        You are generating text inside Forge. Do not invoke tools, read files, inspect the \
    ...
    private func start(
        ...
        do {
            ...
            continuation.finish(
                throwing: AIProviderError.unavailable(
                    "Forge could not prepare its private AI workspace."))
            return
        }
    ...
    private var arguments: [String] {
        ...
        case .openCode:
            var result = [
                ...
                "--dir", workspace.path, "--title", "Forge"
            ]
