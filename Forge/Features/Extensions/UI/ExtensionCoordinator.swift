...
final class ExtensionCoordinator {
            ...
            guard
                await core.confirm(
                    ...
                    message:
                        ...
                        + "holds a JavaScript engine in memory until you leave it — expect Forge "
    ...
    func showExtensionSettings(for owner: InstalledExtension) {
        ...
        NotificationCenter.default.post(
            name: .forgeSelectExtension, object: owner.manifest.name)
    }
...
extension Notification.Name {
    ...
    static let forgeSelectExtension = Notification.Name("forgeSelectExtension")
}
