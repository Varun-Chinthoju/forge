...
struct SymbolCategory: Identifiable, Hashable, Sendable {
    ...
    static let suggested = SymbolCategory(id: "forge.suggested", title: "Suggested")
    static let all = SymbolCategory(id: "forge.all", title: "All Symbols")
    static let bundled = SymbolCategory(id: "forge.bundled", title: "Forge")
}
