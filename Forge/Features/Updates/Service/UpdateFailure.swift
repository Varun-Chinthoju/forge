...
enum UpdateFailure: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAppInArchive:
            return "The downloaded archive does not contain Forge."
        case .quarantined:
            return "macOS quarantined the downloaded app and Forge could not clear the flag."
        case .bundleMismatch:
            return "The downloaded app is not this build of Forge."
        case .identityMismatch:
        ...
        case .replaceFailed(let detail):
            return "Forge could not be replaced. \(detail)"
        }
    }
