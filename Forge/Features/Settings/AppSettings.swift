...
final class AppSettings {
    ...
    /// Follow macOS, or pin Forge to one appearance. Applied by `AppCore.applyAppearance()`.
    ...
    /// Off by default: connecting a server is consent to run code Forge did not write.
    var mcpEnabled: Bool {
    ...
    /// Off out of the box: on means Forge may read a selection anywhere and type over it.
    ...
    /// For a toolchain Forge doesn't know — mise or Nix shims are the common case.
