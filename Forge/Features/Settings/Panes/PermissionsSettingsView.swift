        ...
        Form {
            Section {
                LabeledContent {
                    ...
                    Text("Lets Forge paste a clipboard item into the app you were using.")
                }
                ...
                Text("Access Forge needs to work with other apps.")
                    .font(.caption)
            ...
            Section {
                LabeledContent {
                    ...
                    Text("Lets Forge find the join link for the meeting you are about to be in.")
                }
