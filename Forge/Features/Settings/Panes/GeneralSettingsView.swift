...
struct GeneralSettingsView: View {
    ...
    private var hyperSubtitle: String {
        ...
        return
            ...
            + " Hyper Key shortcuts are shown in Forge with ✦."
    }
    ...
    var body: some View {
        ...
        return Form {
            ...
            Section {
                ...
                Text(
                    "Forge privately learns which results you choose for each query. Reset all learned choices to restore the default order."
                )
                .font(.caption)
                .foregroundStyle(.secondary)
            }
            ...
            Section {
                ...
                if hyperTap.status == .needsAccessibility {
                    LabeledContent {
                        ...
                        Label(
                            "Forge needs Accessibility access to remap keys.",
            ...
            Section {
                Picker(selection: $settings.appearance) {
                    ...
                    Text("Match macOS, or pin Forge to Light or Dark.")
                }
                InterfaceSizeRow()
            ...
            Section {
                Toggle(isOn: $settings.launchAtLogin) {
                    ...
                    Text("Start Forge automatically when you log in.")
                }
                Toggle(isOn: $showInMenuBar) {
                    SettingsRowTitle(.generalGeneral, "Show in menu bar")
                    Text("Keep the Forge icon in the menu bar. Shortcuts still work when hidden.")
                }
        ...
        .confirmationDialog(
            ...
            Text("Forge will relearn your preferred results as you use the launcher.")
        }
