...
struct AboutView: View {
    ...
    private var footer: some View {
        Text("Forge · Based on Tinycast · AGPL-3.0")
            .font(.caption2)
...
private struct AboutLink: Identifiable {
    ...
    static let all: [AboutLink] = [
        AboutLink(
            ...
            detail: "github.com/Varun-Chinthoju/forge",
            url: URL(string: "https://github.com/Varun-Chinthoju/forge")!),
        AboutLink(
            id: "upstream", glyph: .symbol("arrow.triangle.branch"), title: "Upstream",
