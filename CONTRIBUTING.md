...
Check existing [issues](https://github.com/Varun-Chinthoju/forge/issues) and
[pull requests](https://github.com/Varun-Chinthoju/forge/pulls) first.
...
- **No bloat.** Forge stays small on purpose — quality over quantity. A clean patch still gets
...
- `open Forge.xcodeproj` → ⌘R. Debug builds are their own channel (`Forge Dev.app`).
...
macOS version, Forge version + channel, steps, expected vs actual. A recording beats a paragraph.
