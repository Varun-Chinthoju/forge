...
Include your macOS version, the Forge version and channel, reproduction steps, and the impact.
...
Current stable and beta only. Update (`brew upgrade --cask forge`) before reporting.
...
- **Network** — Forge is offline by default and every networked feature is consent-gated. A path
