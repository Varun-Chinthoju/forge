...
const ANCHORS = "Forge/Features/Settings/SettingsAnchor.swift";
const CATALOG = "Forge/Features/Settings/SettingsSearchCatalog.swift";
...
const source = swiftSources(path.join(ROOT, "Forge"))
