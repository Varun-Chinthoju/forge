// Bundles the embedded extension runtime into Forge/Resources/RaycastRuntime.generated.js.
//
//   pnpm install && node gen-enums.mjs && node build.mjs
//
// The output is committed (like EmojiData.generated.swift) so building Forge never needs Node.

import { build } from "esbuild";
import { mkdirSync, statSync, writeFileSync } from "node:fs";
import { dirname, resolve } from "node:path";

const outFile = resolve("../../Forge/Resources/RaycastRuntime.generated.js");
...
// `__forgeCompile` has to compile in the *global* scope so the extension bundle it evaluates can't
