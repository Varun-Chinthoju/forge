#!/usr/bin/env node
// Generate Forge/Features/Calculator/Model/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "Forge/Features/Calculator/Model/CurrencyData.generated.swift");
